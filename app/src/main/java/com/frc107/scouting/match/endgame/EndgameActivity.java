...
public class EndgameActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SandstormData sandstormData = getIntent().getParcelableExtra(ScoutingStrings.SANDSTORM_DATA_EXTRA_KEY);
        CyclesData cyclesData = getIntent().getParcelableExtra(ScoutingStrings.CYCLE_DATA_EXTRA_KEY);
