...
public class SandstormModel extends ViewModel {
    ...
    void setMatchNumber(String matchNumberString) {
        if (StringUtils.isEmptyOrNull(matchNumberString)) {
            ...
            Vanguard.getInstance().setMatchNumber(null);
            return;
        }
        ...
        try {
            ...
            Vanguard.getInstance().setMatchNumber(num);
    ...
    Integer getMatchNumber() {
        return Vanguard.getInstance().getMatchNumber();
    }
    ...
    void finish() {
        ...
        Vanguard.getInstance().setMatchNumber(data.getMatchNumber() + 1);
    }
}
