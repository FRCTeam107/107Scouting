...
import com.frc107.vanguard.core.ui.questionwrappers.RadioWrapper;
import com.frc107.vanguard.core.utils.ViewUtils;
import com.frc107.vanguard.deepspace.DeepSpaceStrings;
import com.frc107.vanguard.deepspace.match.endgame.EndgameActivity;
...
public class CycleActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sandstormData = getIntent().getParcelableExtra(DeepSpaceStrings.SANDSTORM_DATA_EXTRA_KEY);
    ...
    private void openEndgameActivity() {
        ...
        intent.putExtra(DeepSpaceStrings.SANDSTORM_DATA_EXTRA_KEY, sandstormData);
        intent.putExtra(DeepSpaceStrings.CYCLE_DATA_EXTRA_KEY, model.getData());
