...
import com.frc107.vanguard.core.ui.questionwrappers.TextWrapper;
import com.frc107.vanguard.core.utils.PermissionUtils;
import com.frc107.vanguard.deepspace.DeepSpaceStrings;
import com.frc107.vanguard.deepspace.match.cycle.CycleActivity;
...
public class SandstormActivity extends BaseActivity {
    ...
    public void enterCycles(View view) {
        ...
        intent.putExtra(DeepSpaceStrings.SANDSTORM_DATA_EXTRA_KEY, data);
