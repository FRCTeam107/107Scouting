package com.frc107.vanguard.core.ui;
...
import com.frc107.vanguard.BuildConfig;
import com.frc107.vanguard.MainActivity;
import com.frc107.vanguard.R;
import com.frc107.vanguard.Vanguard;
import com.frc107.vanguard.core.VanguardStrings;
import com.frc107.vanguard.core.file.SendFileActivity;
import com.frc107.vanguard.core.utils.PermissionUtils;
import com.frc107.vanguard.core.utils.StringUtils;
import com.frc107.vanguard.core.utils.ViewUtils;
import com.frc107.vanguard.core.utils.callbacks.ICallback;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        Vanguard.getFileService().reloadFileDefinitions();
    }

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        sharedPreferences = getApplicationContext().getSharedPreferences(VanguardStrings.PREFERENCES_NAME, MODE_PRIVATE);
    }
    ...
    public void showInitialsDialog(ICallback onFinish) {
        ...
        alertBuilder.setPositiveButton("OK", (dialog, which) -> {
            ...
            Vanguard.getInstance().setUserInitials(text);

            SharedPreferences.Editor prefEditor = getSharedPreferences().edit();
            prefEditor.putString(VanguardStrings.USER_INITIALS_PREFERENCE, text);
            prefEditor.apply();
