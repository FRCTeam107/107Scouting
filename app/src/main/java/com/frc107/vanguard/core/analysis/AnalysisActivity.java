...
import com.frc107.vanguard.core.file.SelectFileForAnalysisActivity;
...
public class AnalysisActivity extends BaseActivity {
    ...
    private void openFileSelectionActivity(eTableType tableType) {
        ...
        intent.putExtra(VanguardStrings.TABLE_EXTRA_KEY, tableType);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        String path = data.getStringExtra(VanguardStrings.FILE_SELECTION_EXTRA_KEY);
        if (path == null) {
