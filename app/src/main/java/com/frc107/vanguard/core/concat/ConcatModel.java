package com.frc107.vanguard.core.concat;
...
public class ConcatModel extends ViewModel {
    ...
    void selectConcatOption(int position) {
        ...
        availableFileDefs.addAll(Vanguard.getFileService().getFileDefinitionsOfType(tableType, false));
    ...
    String concatenate() {
        ...
        try {
            File file = Vanguard.getFileService().concatenateFiles(tableType, files);
