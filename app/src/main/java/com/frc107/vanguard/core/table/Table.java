package com.frc107.vanguard.core.table;
...
import com.frc107.vanguard.core.utils.callbacks.ICallbackWithParamAndResult;
...
public class Table {
    ...
    public boolean importData(String data, ICallbackWithParamAndResult<Row, Boolean> forEachRow) {
        String[] lines = data.split(VanguardStrings.NEW_LINE);
